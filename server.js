...
io.on('connection', function(socket){
    ...
    socket.on('new_user', user => {
        if(user.userName in users) {
            ...
            //By default we connected to public chat
            socket.join('public', () => {
